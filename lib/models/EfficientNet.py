...
class EfficientNet(nn.Module):
    ...
    def extract_features(self, inputs, return_residual=True):
        ...
        for idx, block in enumerate(self._blocks):
            ...
            if residual[-1].shape[-2:] == x.shape[-2:]:
                residual.pop()
            residual.append(x)
        ...
        # print(inputs.shape)
        # for idx,res in enumerate(residual):
        #     print(f"shape #{idx}: {res.shape}")
        # exit(0)
